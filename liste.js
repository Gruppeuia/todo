...
router.get('/', bodyParser, function (req, res) {   
    ...
    SELECT * FROM public.todoview WHERE loginname=$1;
...
router.post('/', bodyParser, function (req, res) {   
   ...
   var sql = `PREPARE insert_list (int, text, text, Date, int, Boolean, text) AS
     ...
     //var sql = `INSERT INTO liste VALUES(DEFAULT, '${upload.listenavn}', '${upload.beskrivelse}', '${upload.tid}', ${upload.prioritet}, '${upload.status}')`;
